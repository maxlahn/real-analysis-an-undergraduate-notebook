...
},
{
  ...
  "level": "2",
  "url": "section-notions-of-metric-continuity.html#definition-continuity",
  "type": "Definition",
  "number": "3.5.2",
  "title": "Continuity.",
...
},
{
  ...
  "level": "2",
  "url": "section-notions-of-metric-continuity.html#example-continuity",
  "type": "Example",
  "number": "3.5.3",
  "title": "Continuity.",
...
},
{
  ...
  "body": " Bounds on topologies   The lattice of topologies on a set is a bounded partially ordered set.    Consider the lattice of topologies on a set . We observe that for all topologies , and so is bounded from above and below.   "
},
{
...
{
  "id": "theorem-lattice-of-topologies",
  "level": "2",
  "url": "section-comparison-and-topology.html#theorem-lattice-of-topologies",
  "type": "Theorem",
  "number": "4.2.6",
  "title": "Lattice of topologies.",
  "body": " Lattice of topologies   The lattice of topologies on a set is a complete lattice; that is, any collection of topologies on has a unique supremum and infimum.    Let be a collection of topologies on a set . Since the intersection is an infimum for in the partially ordered set , it is an infimum for in ; that is, this intersection is the finest common coarsening of the topologies in . It therefore suffices to show that has a supremum.  To that end, let be the topology on generated by the union of all topologies in . Then is a common refinement of each topology in . Moreover, if is a common refinement of each topology in , then it contains the union of all such topologies, and therefore is a refinement of . Thus is an infimum for in ; that is, this intersection is the coarsest common refinement of the topologies in .   "
},
{
