...
},
{
  ...
  "body": " Net convergence and subspaces   Let be a subset of a topological space , and consider a net of points indexed by an upwards directed set . Prove that for a point , converges upwards to as a net in if and only if it converges upwards to as a net in .    What are the neighborhoods of in the subspace ?    First suppose that converges upwards to as a net in , and let be a neighborhood of in . Then for some open set in . We recall that for some open set in , and so is a neighborhood of in .  Since converges upwards to as a net in , there is some index so that for all indices . We observe that for all indices , and so converges upwards to as a net in .  Conversely, now suppose that converges upwards to as a net in , and let be a neighborhood of in . Then for some open set in . Let , and observe that is a neighborhood of in .  Since converges upwards to as a net in , there is some index so that for all indices . We observe that for all indices , and so converges upwards to as a net in .   "
},
{
